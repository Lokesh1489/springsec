...
public class purshaseorderImpl implements IPurchaseOrder {
	...
	private String sendMail(String msg, String[] toEmails) throws Exception {
		...
		helper.setText(msg);
		helper.addAttachment("05-Introduction to Spring.pptx", new FileSystemResource("C:\\Users\\lokesh.d\\Desktop\\05-Introduction to Spring.pptx"));
		sender.send(message);
		return "mail send";
	}
